namespace SpectrumV1.Views.Users
{
	partial class UserEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.grpUserInfo = new DevExpress.XtraLayout.LayoutControlGroup();
			...
			this.mainLayout.Controls.Add(this.chkChangePasswordNextLogon);
			this.mainLayout.Controls.Add(this.txtEmail);
			this.mainLayout.Controls.Add(this.changePasswordLink);
			this.mainLayout.Controls.Add(this.chkActive);
			this.mainLayout.Controls.Add(this.txtUsername);
			this.mainLayout.Controls.Add(this.txtPassword);
			...
			this.btnCancel.Location = new System.Drawing.Point(592, 545);
			...
			// btnSave
			// 
			this.btnSave.Location = new System.Drawing.Point(462, 545);
			...
			this.chkChangePasswordNextLogon.StyleController = this.mainLayout;
			this.chkChangePasswordNextLogon.TabIndex = 13;
			// 
			// txtEmail
			// 
			...
			this.txtEmail.Size = new System.Drawing.Size(415, 22);
			...
			this.changePasswordLink.StyleController = this.mainLayout;
			this.changePasswordLink.TabIndex = 10;
			this.changePasswordLink.Text = "Change Password";
			this.changePasswordLink.Click += new System.EventHandler(this.changePasswordLink_ClickAsync);
			// 
			// chkActive
			// 
			...
			this.txtUsername.Size = new System.Drawing.Size(415, 22);
			this.txtUsername.StyleController = this.mainLayout;
			...
			this.txtPassword.StyleController = this.mainLayout;
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(756, 586);
			this.Root.TextVisible = false;
			// 
			// grpUserInfo
			// 
			this.grpUserInfo.GroupStyle = DevExpress.Utils.GroupStyle.Light;
			this.grpUserInfo.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[] {
            this.lblUsername,
			...
			this.lblUsername.Size = new System.Drawing.Size(492, 26);
			this.lblUsername.Text = "Username";
			this.lblUsername.TextSize = new System.Drawing.Size(58, 16);
			// 
			// emptySpaceItem2
			// 
			this.emptySpaceItem2.Location = new System.Drawing.Point(492, 0);
			this.emptySpaceItem2.Name = "emptySpaceItem2";
			this.emptySpaceItem2.Size = new System.Drawing.Size(202, 26);
			// 
			// emptySpaceItem3
			// 
			this.emptySpaceItem3.Location = new System.Drawing.Point(598, 36);
			this.emptySpaceItem3.Name = "emptySpaceItem3";
			this.emptySpaceItem3.Size = new System.Drawing.Size(96, 29);
			// 
			// emptySpaceItem6
			// 
			this.emptySpaceItem6.Location = new System.Drawing.Point(0, 26);
			this.emptySpaceItem6.Name = "emptySpaceItem6";
			this.emptySpaceItem6.Size = new System.Drawing.Size(694, 10);
			// 
			// lblPassword
			// 
			this.lblPassword.Control = this.txtPassword;
			this.lblPassword.Location = new System.Drawing.Point(0, 36);
			this.lblPassword.Name = "lblPassword";
			this.lblPassword.Size = new System.Drawing.Size(492, 29);
			this.lblPassword.Text = "Password";
			this.lblPassword.TextSize = new System.Drawing.Size(58, 16);
			// 
			// lblEmail
			// 
			this.lblEmail.Control = this.txtEmail;
			this.lblEmail.Location = new System.Drawing.Point(0, 65);
			this.lblEmail.Name = "lblEmail";
			this.lblEmail.Size = new System.Drawing.Size(492, 26);
			this.lblEmail.Text = "Email";
			this.lblEmail.TextSize = new System.Drawing.Size(58, 16);
			// 
			// layoutControlItem2
			// 
			this.layoutControlItem2.Control = this.changePasswordLink;
			this.layoutControlItem2.Location = new System.Drawing.Point(492, 36);
			...
			// emptySpaceItem7
			// 
			this.emptySpaceItem7.Location = new System.Drawing.Point(492, 65);
			...
			// grpAccessPermission
			// 
			this.grpAccessPermission.GroupStyle = DevExpress.Utils.GroupStyle.Light;
			this.grpAccessPermission.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[] {
			...
			this.layoutControlItem4.Location = new System.Drawing.Point(448, 531);
			...
			this.layoutControlItem5.Location = new System.Drawing.Point(578, 531);
			...
			// emptySpaceItem10
			// 
			this.emptySpaceItem10.Location = new System.Drawing.Point(0, 531);
		...
		private DevExpress.XtraLayout.LayoutControlGroup grpUserInfo;
		...
		private DevExpress.XtraEditors.CheckEdit chkChangePasswordNextLogon;
		private DevExpress.XtraLayout.LayoutControlGroup grpAccessPermission;
		...
		private DevExpress.XtraEditors.LookUpEdit cboRoles;
